...
def plot_basic(stocks, title='Yahoo Finance', y_label='Price USD', x_label='Trading Days'):
    """
    Plots basic pyplot
    ...
    """
    fig, ax = plt.subplots()
    ax.plot(stocks['Item'], stocks['Close'], '#690073')
...
def plot_lstm_prediction(actual, prediction, title='Yahoo Finance vs Prediction', y_label='Price USD', x_label='Trading Days'):
    """
    Plots train, test and prediction
    :param actual: DataFrame containing actual data
    :param prediction: DataFrame containing predicted values
